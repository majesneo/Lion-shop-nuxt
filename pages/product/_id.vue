          ...
          <div class="col-md-6">
            <div class="product-gallery product-gallery-separated">
              ...
              <figure class="product-separated-item">
                ...
                <a id="btn-separated-gallery" href="#" class="btn-product-gallery">
                  <i class="icon-arrows" />
                </a>
              </figure>
          ...
          <div class="col-md-6">
            <div class="product-details sticky-content">
              ...
              <div class="ratings-container">
                ...
                <a id="review-link" class="ratings-text" href="#product-accordion">( 2 Reviews )</a>
              ...
              <div class="product-countdown" data-until="2019, 10, 29" /><!-- End .product-countdown -->
              ...
              <div class="details-filter-row details-row-size">
                ...
                <a href="#" class="size-guide"><i class="icon-th-list" />size guide</a>
              ...
              <div class="product-details-footer">
                ...
                <div class="social-icons social-icons-sm">
                  ...
                  <a href="#" class="social-icon" title="Facebook" target="_blank"><i class="icon-facebook-f" /></a>
                  <a href="#" class="social-icon" title="Twitter" target="_blank"><i class="icon-twitter" /></a>
                  <a href="#" class="social-icon" title="Instagram" target="_blank"><i class="icon-instagram" /></a>
                  <a href="#" class="social-icon" title="Pinterest" target="_blank"><i class="icon-pinterest" /></a>
                </div>
              </div><!-- End .product-details-footer -->

              <div id="product-accordion" class="accordion accordion-plus product-details-accordion">
                <div class="card card-box card-sm">
                  <div id="product-desc-heading" class="card-header">
                    <h2 class="card-title">
                      <a
                        class="collapsed"
                        role="button"
                    ...
                    <div class="card-body">
                      <div class="product-desc-content">
                        <p>
                          ...
                          eros. Nullam malesuada erat ut turpis. Suspendisse urna viverra non, semper suscipit, posuere
                          a, pede. Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet
                          orci.
                        </p>
                        <ul>
                ...
                <div class="card card-box card-sm">
                  <div id="product-info-heading" class="card-header">
                    <h2 class="card-title">
                      <a
                        role="button"
                        data-toggle="collapse"
                ...
                <div class="card card-box card-sm">
                  <div id="product-shipping-heading" class="card-header">
                    <h2 class="card-title">
                      <a
                        class="collapsed"
                        role="button"
                ...
                <div class="card card-box card-sm">
                  <div id="product-review-heading" class="card-header">
                    <h2 class="card-title">
                      <a
                        class="collapsed"
                        role="button"
                            ...
                            <div class="col">
                              ...
                              <div class="review-content">
                                <p>
                                  ...
                                  assumenda asperiores facilis porro reprehenderit animi culpa atque blanditiis commodi
                                  perspiciatis doloremque, possimus, explicabo, autem fugit beatae quae voluptas!
                                </p>
                              </div><!-- End .review-content -->

                              <div class="review-action">
                                <a href="#"><i class="icon-thumbs-up" />Helpful (2)</a>
                                <a href="#"><i class="icon-thumbs-down" />Unhelpful (0)</a>
                        ...
                        <div class="review">
                          <div class="row no-gutters">
                            ...
                            <div class="col">
                              ...
                              <div class="review-action">
                                <a href="#"><i class="icon-thumbs-up" />Helpful (0)</a>
                                <a href="#"><i class="icon-thumbs-down" />Unhelpful (0)</a>
                              </div><!-- End .review-action -->
                            </div><!-- End .col-auto -->
                          </div><!-- End .row -->
        ...
        <carousel>
          ...
          <div class="product product-7">
            ...
            <div class="product-body">
              ...
              <div class="ratings-container">
                <div class="ratings">
                  <div class="ratings-val" style="width: 0%;" /><!-- End .ratings-val -->
                </div><!-- End .ratings -->
