            ...
            <div class="product-gallery product-gallery-separated">
              ...
              <figure class="product-separated-item">
                <img src="assets/images/products/single/sticky/1.jpg"
                     data-zoom-image="assets/images/products/single/sticky/1-big.jpg" alt="product image">
              ...
              <figure class="product-separated-item">
                <img src="assets/images/products/single/sticky/2.jpg"
                     data-zoom-image="assets/images/products/single/sticky/2-big.jpg" alt="product image">
              </figure>

              <figure class="product-separated-item">
                <img src="assets/images/products/single/sticky/3.jpg"
                     data-zoom-image="assets/images/products/single/sticky/3-big.jpg" alt="product image">
              </figure>

              <figure class="product-separated-item">
                <img src="assets/images/products/single/sticky/4.jpg"
                     data-zoom-image="assets/images/products/single/sticky/4-big.jpg" alt="product image">
              </figure>
              ...
              <div class="accordion accordion-plus product-details-accordion" id="product-accordion">
                ...
                <div class="card card-box card-sm">
                  <div class="card-header" id="product-info-heading">
                    <h2 class="card-title">
                      <a role="button" data-toggle="collapse" href="#product-accordion-info" aria-expanded="true"
                         aria-controls="product-accordion-info">
                        Additional Information
                      </a>
                    </h2>
                  </div><!-- End .card-header -->
                  <div id="product-accordion-info" class="collapse show" aria-labelledby="product-info-heading"
                       data-parent="#product-accordion">
                    <div class="card-body">
                      <div class="product-desc-content">
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis
                            ...
                            <div class="col">
                              ...
                              <div class="review-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus cum dolores
                                  ...
                                  perspiciatis doloremque, possimus, explicabo, autem fugit beatae quae voluptas!</p>
